...
import { Button, FormControl, InputLabel, Input, Grid, Select, MenuItem, makeStyles } from '@material-ui/core';
  ...
  return (
    <div className="App">
      ...
      <form>
        ...
        <Button id="addTaskButton" disabled={!input.trim() || !inputUser} type="submit" onClick={addTask} variant="contained" color="primary">
          Add Task
        </Button>
      </form>
